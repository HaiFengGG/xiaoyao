...
proxies:
  -
    ...
    plugin-opts:
      mode: http
      host: 909e6250.microsoft.com
  -
    name: '俄罗斯 | 2 | Netflix'
    type: ss
    server: ss-ru2.bgpnode.com
    port: 6025
    cipher: rc4-md5
    password: bcfbaW
    udp: true
    ...
    plugin-opts:
      ...
      host: 909e6250.microsoft.com
  -
    name: '台湾 | 1 | Netflix 动画疯 Bilibili'
    type: ss
    server: ss-tw1.bgpnode.com
    port: 6025
    cipher: rc4-md5
    password: bcfbaW
    udp: true
    ...
    plugin-opts:
      ...
      host: 909e6250.microsoft.com
  -
    name: '台湾 | 2 | Netflix 动画疯 Bilibili'
    type: ss
    server: ss-tw2.bgpnode.com
    port: 6025
    cipher: rc4-md5
    password: bcfbaW
    udp: true
  ...
  -
    ...
    plugin-opts:
      ...
      host: 909e6250.microsoft.com
  -
    name: '日本 | 1 | Netflix  [0.5倍率]'
    type: ss
    server: ss-jp1.bgpnode.com
    port: 6024
    cipher: rc4-md5
    password: bcfbaW
    udp: true
    ...
    plugin-opts:
      ...
      host: 909e6250.microsoft.com
  -
    name: '日本 | 2 | Netflix  [0.5倍率]'
    type: ss
    server: ss-jp2.bgpnode.com
    port: 6024
    cipher: rc4-md5
    password: bcfbaW
    udp: true
    ...
    plugin-opts:
      ...
      host: 909e6250.microsoft.com
  -
    name: '日本 | 3 | Netflix  [0.5倍率]'
    type: ss
    server: ss-jp3.bgpnode.com
    port: 6024
    cipher: rc4-md5
    password: bcfbaW
    udp: true
    ...
    plugin-opts:
      ...
      host: 909e6250.microsoft.com
  -
    name: '日本 | 4 | Netflix  [0.5倍率]'
    type: ss
    server: ss-jp4.bgpnode.com
    port: 6024
    cipher: rc4-md5
    password: bcfbaW
    udp: true
    ...
    plugin-opts:
      ...
      host: 909e6250.microsoft.com
  -
    name: '美国 | 1 | Netflix Hbo hulu'
    type: ss
    server: ss-us1.bgpnode.com
    port: 6024
    cipher: rc4-md5
    password: bcfbaW
    udp: true
    ...
    plugin-opts:
      ...
      host: 909e6250.microsoft.com
  -
    name: '美国 | 2 | Netflix Hbo hulu'
    type: ss
    server: ss-us2.bgpnode.com
    port: 6024
    cipher: rc4-md5
    password: bcfbaW
    udp: true
    ...
    plugin-opts:
      ...
      host: 909e6250.microsoft.com
  -
    name: '美国 | 3 | Netflix Hbo hulu'
    type: ss
    server: ss-us3.bgpnode.com
    port: 6024
    cipher: rc4-md5
    password: bcfbaW
    udp: true
    ...
    plugin-opts:
      ...
      host: 909e6250.microsoft.com
  -
    name: '美国 | 4 | Netflix Hbo hulu'
    type: ss
    server: ss-us4.bgpnode.com
    port: 6024
    cipher: rc4-md5
    password: bcfbaW
    udp: true
  ...
  -
    ...
    plugin-opts:
      ...
      host: 909e6250.microsoft.com
  -
    name: '韩国 | 1 | Netflix  [0.5倍率]'
    type: ss
    server: ss-kr1.bgpnode.com
    port: 6025
    cipher: rc4-md5
    password: bcfbaW
    udp: true
    ...
    plugin-opts:
      ...
      host: 909e6250.microsoft.com
  -
    name: '韩国 | 2 | Netflix  [0.5倍率]'
    type: ss
    server: ss-kr2.bgpnode.com
    port: 6025
    cipher: rc4-md5
    password: bcfbaW
    udp: true
    ...
    plugin-opts:
      ...
      host: 909e6250.microsoft.com
  -
    name: '韩国 | 3 | Netflix  [0.5倍率]'
    type: ss
    server: ss-kr3.bgpnode.com
    port: 6025
    cipher: rc4-md5
    password: bcfbaW
    udp: true
    ...
    plugin-opts:
      ...
      host: 909e6250.microsoft.com
  -
    name: '香港 | 1 | Netflix Hbo TVB Bilbili'
    type: ss
    server: ss-hk1.bgpnode.com
    port: 6024
    cipher: rc4-md5
    password: bcfbaW
    udp: true
    ...
    plugin-opts:
      ...
      host: 909e6250.microsoft.com
  -
    name: '香港 | 2 | Netflix Hbo TVB Bilbili  [0.5倍率]'
    type: ss
    server: ss-hk2.bgpnode.com
    port: 6025
    cipher: rc4-md5
    password: bcfbaW
    udp: true
...
proxy-groups:
  -
    ...
    proxies:
      - '俄罗斯 | 1 | Netflix'
      - '俄罗斯 | 2 | Netflix'
      - '台湾 | 1 | Netflix 动画疯 Bilibili'
      - '台湾 | 2 | Netflix 动画疯 Bilibili'
      - '新加坡 | 1 | Netflix'
      - '新加坡 | 2 | Netflix'
      - '新加坡 | 3 | Netflix'
      - '新加坡 | 4 | Netflix'
      ...
      - '日本 | 3 | Netflix  [0.5倍率]'
      - '日本 | 4 | Netflix  [0.5倍率]'
      - '美国 | 1 | Netflix Hbo hulu'
      - '美国 | 2 | Netflix Hbo hulu'
      - '美国 | 3 | Netflix Hbo hulu'
      - '美国 | 4 | Netflix Hbo hulu'
      - '菲律宾 | 1 | Netflix'
      - '韩国 | 1 | Netflix  [0.5倍率]'
      - '韩国 | 2 | Netflix  [0.5倍率]'
      - '韩国 | 3 | Netflix  [0.5倍率]'
      - '香港 | 1 | Netflix Hbo TVB Bilbili'
      - '香港 | 2 | Netflix Hbo TVB Bilbili  [0.5倍率]'
      - 🚀直接连接
  -
    name: ⚓️其他流量
    type: select
